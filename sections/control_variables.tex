...
The plasma shaping steps commenced by 7s and the shot was programmed for flat-top up to 17s providing a 10s long window for the detachment control experiment.
...
We estimate the width of the ion saturation current profile at half the maximum value referenced to the baseline value of 0.05 A measured by far away probes, giving approximately at least a 16 mm wide profile.
