...
% DE comment: \textcolor{red}{Maybe mention here that the impurity estimator wasn't connected properly for these experiments/it malfunctioned?}
% Response: I've mentioned it later in results section.
