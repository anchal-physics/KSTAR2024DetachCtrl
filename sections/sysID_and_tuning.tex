...
%\fixme{should we add a note about multi-sine sys id? to acknowledge that that is also a thing} % no time
...
%Transfer functions describe relationships between system output and system input, and the \aq{CLTF} in particular describes how system output will relate to the control target.
...
\fixme{Statement about divertor cooling being a reasonable response to gas puffing, even for attached plasma?}
