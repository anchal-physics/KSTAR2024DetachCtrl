...
Burning plasma tokamaks such as ITER\cite{Holtkamp_2007_FED}, SPARC\cite{Creely_2020_JPP}, and the various DEMO\cite{} and \ac{FPP}\cite{} concepts are estimated to exhaust very high heat flux in the \ac{SOL} towards the divertor target.
% DEMO: could try something like https://doi.org/10.1016/j.fusengdes.2014.01.070 as an example
% FPP example: 10.1088/1741-4326/abe4af
...
%At higher temperatures, more and more electrons get stripped away from the neutral atoms and the radiation reduces and the main dissipation mechanism becomes charge exchange and ionization.%No... there just isn't much dissipation from deuterium in the core. There's no charge exchange in there except with neutral beams, but those neutrals have even higher energy than the plasma so they heat instead of cooling.
...
\textcolor{red}{Is this needed at this stage in the intro? Maybe, but I'd have to keep reading to see.}
